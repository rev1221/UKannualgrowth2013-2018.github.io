...
import json
db = pd.read_excel(r"C:\Users\hkhaled\Music\Documents\statistics\python programs\HTML\github page\spartial data\uk annual growth rate by region(cleaned).xlsx",
                   sheet_name="Dataset"
                   )
with open('map.geojson', 'r') as myfile:
    data=myfile.read()
